...
2. Load `agents/[persona].docs/state.md` - Your accumulated knowledge, what you were working on, and the resume plan, all in one file

**WORK:**
3. Execute assigned tasks and complete steps
4. Summarize work in `agents/[persona].docs/<TASKNAME>_Summary_<YYYY-mm-ddTHH:MM>.md`
5. Post updates to `agents/CHAT.md` using `agents/templates/_template_CHAT.md`

**EXIT (Before Switching - MANDATORY):**
6. Update `agents/[persona].docs/state.md` - Key decisions/findings, progress %, completed items, next items, follow-up tasks (Context, Current Task, Next Steps sections). Replace/merge content as needed.
